    ...
    <Box sx={{ py: 8, backgroundColor: "#f9f9f9" }}>
      <Container>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={4} data-aos="fade-up" data-aos-duration="1400" data-aos-delay="300">
            <Card
              sx={{
                display: "flex",
                flexDirection: "column",
          ...
          <Grid item xs={12} md={4} data-aos="fade-up" data-aos-duration="1600" data-aos-delay="600">
            <Card
              sx={{
                display: "flex",
                flexDirection: "column",
